...
train_dataloader = dict(batch_size=4, num_workers=4, persistent_workers=True,
                        ...
                        dataset=dict(type=dataset_type,
                                     data_root=data_root,
                                     ann_file='nuscenes_infos_train__Class-Agnostic__Labels-GT.pkl',
...
val_evaluator  = dict(type='NuScenesMetric',
                      ...
                      metric='bbox',
                      backend_args=backend_args,
                      jsonfile_prefix='work_dirs/CenterPoint-Pillar0200__second-secfpn-8xb4-cyclic-20e-nus-3d__Class-Agnostic-Training__Labels-GT__UNION-file')
