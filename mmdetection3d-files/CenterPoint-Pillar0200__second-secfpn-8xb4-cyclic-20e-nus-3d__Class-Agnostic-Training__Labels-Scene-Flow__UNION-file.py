...
_base_ = ['../_base_/datasets/nus-3d.py',
          '../_base_/models/CenterPoint-Pillar0200__second-secfpn-nus__Class-Agnostic-Model__UNION-file.py',
...
train_dataloader = dict(batch_size=4, num_workers=4, persistent_workers=True,
                        ...
                        dataset=dict(type=dataset_type,
                                     data_root=data_root,
                                     ann_file='nuscenes_infos_train__Class-Agnostic__Labels-Scene-Flow.pkl',
...
val_dataloader   = dict(batch_size=1, num_workers=1, persistent_workers=True, drop_last=False,
                        ...
                        dataset=dict(type=dataset_type,
                                     data_root=data_root,
                                     ann_file='nuscenes_infos_val__Class-Agnostic__Labels-GT.pkl',
...
val_evaluator  = dict(type='NuScenesMetric',
                      data_root=data_root,
                      ann_file=data_root+'nuscenes_infos_val__Class-Agnostic__Labels-GT.pkl',
                      metric='bbox',
                      backend_args=backend_args,
                      jsonfile_prefix='work_dirs/CenterPoint-Pillar0200__second-secfpn-8xb4-cyclic-20e-nus-3d__Class-Agnostic-Training__Labels-Scene-Flow__UNION-file')
