...
_base_ = ['../_base_/datasets/nus-3d.py',
          '../_base_/models/CenterPoint-Pillar0200__second-secfpn-nus__Multi-Class-010pc-Model__UNION-file.py',
...
class_names       = ['pseudoclass000', 'pseudoclass001', 'pseudoclass002', 'pseudoclass003', 'pseudoclass004', 'pseudoclass005', 'pseudoclass006', 'pseudoclass007', 'pseudoclass008', 'pseudoclass009']
...
train_dataloader = dict(batch_size=4, num_workers=4, persistent_workers=True,
                        ...
                        dataset=dict(type=dataset_type,
                                     data_root=data_root,
                                     ann_file='nuscenes_infos_train__Multi-Class-003__Labels-UNION-010pc.pkl',
...
val_evaluator  = dict(type='NuScenesMetric',
                      ...
                      metric='bbox',
                      backend_args=backend_args,
                      jsonfile_prefix='work_dirs/CenterPoint-Pillar0200__second-secfpn-8xb4-cyclic-20e-nus-3d__Multi-Class-003-Training__Labels-UNION-010pc__UNION-file')
