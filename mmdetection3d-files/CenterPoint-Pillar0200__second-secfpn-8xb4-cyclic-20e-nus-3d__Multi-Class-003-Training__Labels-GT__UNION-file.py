...
_base_ = ['../_base_/datasets/nus-3d.py',
          '../_base_/models/CenterPoint-Pillar0200__second-secfpn-nus__Multi-Class-003-Model__UNION-file.py',
...
train_dataloader = dict(batch_size=4, num_workers=4, persistent_workers=True,
                        ...
                        dataset=dict(type=dataset_type,
                                     data_root=data_root,
                                     ann_file='nuscenes_infos_train__Multi-Class-003__Labels-GT.pkl',
...
val_evaluator  = dict(type='NuScenesMetric',
                      ...
                      metric='bbox',
                      backend_args=backend_args,
                      jsonfile_prefix='work_dirs/CenterPoint-Pillar0200__second-secfpn-8xb4-cyclic-20e-nus-3d__Multi-Class-003-Training__Labels-GT__UNION-file')
