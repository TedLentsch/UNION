...
def plot_velocity_fractions(hyperparameters:Dict, intermediate_results_appearanceclustering_dir:str):
    ...
    plt.savefig(os.path.join('figures', 'figure4-plots', 'velocityfractions.pdf'), bbox_inches='tight')
...
def plot_qualitative_example(nusc:NuScenes, scenes:List, hyperparameters:Dict, intermediate_results_spatialclustering_dir:str, intermediate_results_sceneflow_dir:str, intermediate_results_appearanceclustering_dir:str, USE_MINI_SPLIT:bool, mobile_classes:Dict, load_reference:bool):
    ...
    if load_reference:
        cluster_dict__spatialclustering  = np.load(os.path.join('figures', 'figure3-plots', 'spatialclustering__n015-2018-11-21-19-38-26+0800__LIDAR_TOP__1542800988948006-reference.npy'), allow_pickle=True).item()
        cluster_dict__sceneflow          = np.load(os.path.join('figures', 'figure3-plots', 'sceneflow__n015-2018-11-21-19-38-26+0800__LIDAR_TOP__1542800988948006-reference.npy'), allow_pickle=True).item()
        usage_dict__appearanceclustering = np.load(os.path.join('figures', 'figure3-plots', 'appearanceclustering__n015-2018-11-21-19-38-26+0800__LIDAR_TOP__1542800988948006-reference.npy'), allow_pickle=True).item()
    ...
    plt.savefig(os.path.join('figures', 'figure3-plots', '3a-hdbscan.png'), bbox_inches='tight')
    ...
    plt.ylim(-18,22)
    plt.tick_params(axis='both', left=False, top=False, right=False, bottom=False, labelleft=False, labeltop=False, labelright=False, labelbottom=False)
    plt.savefig(os.path.join('figures', 'figure3-plots', '3b-sceneflow.png'), bbox_inches='tight')
    ...
    plt.ylim(-18,22)
    plt.tick_params(axis='both', left=False, top=False, right=False, bottom=False, labelleft=False, labeltop=False, labelright=False, labelbottom=False)
    plt.savefig(os.path.join('figures', 'figure3-plots', '3c-appearance.png'), bbox_inches='tight')
    ...
    plt.ylim(-18,22)
    plt.tick_params(axis='both', left=False, top=False, right=False, bottom=False, labelleft=False, labeltop=False, labelright=False, labelbottom=False)
    plt.savefig(os.path.join('figures', 'figure3-plots', '3d-groundtruth.png'), bbox_inches='tight')
